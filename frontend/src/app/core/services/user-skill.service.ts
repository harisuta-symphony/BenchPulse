...
import {UserSkill, CreateUserSkill} from '../models/user-skill.model';
...
export class UserSkillService {
    ...
    update(id: string, dto: Partial<CreateUserSkill>): Observable<UserSkill> { return this.http.put<UserSkill>(`${this.base}/${id}`, dto) }
